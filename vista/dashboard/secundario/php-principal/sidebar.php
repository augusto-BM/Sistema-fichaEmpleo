...
<div class="barra-lateral">
    <div class="general">
        ...
        <img class="rounded-circle" src="./imagen-secundario/logo-<?php echo $_SESSION['nombre_sesion']; ?>.png" alt="img-admin" height="80" width="80">

        <div class="">
            <span><?php echo $_SESSION['nombre_sesion']; ?></span>
        </div>
        <h1 class="E-classe text-center ms-auto me-auto h6 nombre-lugar "><b><?php echo $_SESSION['nombre_sede']; ?></b></h1>
    </div>
    <div class="linea"></div>
