                        ...
                        <div class="card-body">
                            <form method="POST" action="../../../controlador/controlador-principal/controlador-agregarEntrevistadores.php" enctype="multipart/form-data">
                                ...
                                <div class="">
                                    ...
                                    <input type="text" class="form-control" id="apellido_materno_entrevistador" name="apellido_materno_entrevistador" style="margin-bottom: 5px;" oninput="soloLetras(this)" onkeyup="validarApellido(this);">
                                </div>
                                <div class="">
