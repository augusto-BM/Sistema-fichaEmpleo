...
<head>
    ...
    <title>Adminitrador Principal - Bkn</title>
    ...
    <main class="dashboard d-flex">
        ...
        <div class="container">
            ...
            <div class="cards row gap-3 justify-content-center mt-2">
                ...
                <div class=" card__items card__items--jbg position-relative col-sm-12 col-md-6 col-lg-6 col-xl-6">
                    <div class="card__Course d-flex flex-column gap-2 mt-3">
                        <span>JBG Operator</span>
                        <p class="pasaron">6 <i class="pasaron fas fa-user-check h3"></i></p>
                        <p class="asistieron">Hoy: <b> &nbsp;15</b> postulantes</p>
                    </div>

                </div>

                <div class=" card__items card__items--bkn position-relative col-sm-12 col-md-6 col-lg-6 col-xl-6">
                    <div class="card__payments d-flex flex-column gap-2 mt-3">
                        <span>BKN</span>
                        <p class="pasaron">3 <i class="pasaron fas fa-user-check h3"></i></p>
                        <p class="asistieron">Hoy: <b> &nbsp;14</b> postulantes</p>
