...
<div class="table-responsive col-sm-12 col-md-12 col-lg-12 col-xl-12">
                ...
                <table class="table student_list table-borderless tabla table-striped tabla w-100" id="myTable2">
                    ...
                    <tbody>
                        ...
                        $sql_id_sede = "SELECT id_sede FROM sede WHERE nombre_sede = '$NOMBRE_EMPRESA'";
                        ...
                        if (mysqli_num_rows($resultado_id_sede) > 0) {
                            ...
                            echo "No se encontró ninguna sede con el nombre '$NOMBRE_EMPRESA'";
                        }

                        $sql = "SELECT * FROM login WHERE estado = 'inactivo' AND id_sede = '$solo_id_sede'";
